...
//             <Link to={"/"} className="text-white text-2xl">Restaurant ABC</Link>
...
//                 <Link to={"/book-table"} className="text-white border rounded-2xl " >Book Table</Link>
//                 <Link to="/cart">
...
const Header = React.memo(() => {
    ...
    return (
        <nav className="bg-blue-400 p-4 flex justify-between items-center">
            <Link to={"/"} className="text-white text-xl font-bold">Restaurant ABC</Link>
