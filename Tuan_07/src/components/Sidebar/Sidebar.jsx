  ...
  return (
    <div className="sidebar">
      ...
      <ul className="menu">
        <li>
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? "flex bg-pink-200 transition duration-400 rounded-2xl mt-4 mb-6 text-xl py-1 px-5 font-bold"
                : "flex hover:bg-pink-200 transition duration-400 rounded-2xl mt-4 mb-6 text-xl py-1 px-5"
            }
          >
            <img
              src="/src/img/four-rounded-squares-button.png"
              alt=""
              className="mr-6 size-6 opacity-65"
            />
            Dashboard
          </NavLink>
        </li>
        <li>
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? "flex bg-pink-200 transition duration-400 rounded-3xl mt-4 mb-6 text-xl py-1 px-5 font-bold"
                : "flex hover:bg-pink-200 transition duration-400 rounded-3xl mt-4 mb-6 text-xl py-1 px-5"
            }
          >
            <img src="/src/img/Folder.png" alt="" className="mr-6" />
            Projects
          </NavLink>
        </li>
        <li>
          ...
          >
            <img src="/src/img/Groups.png" alt="" className="mr-6" />
            Teams
          </NavLink>
        </li>
        <li>
          ...
          >
            <img src="/src/img/Pie chart.png" alt="" className="mr-6" />
            Analytics
          </NavLink>
        </li>
        <li>
          ...
          >
            <img src="/src/img/Chat.png" alt="" className="mr-6" />
            Messages
          </NavLink>
        </li>
        <li>
          ...
          >
            <img src="/src/img/Code.png" alt="" className="mr-6" />
            Integrations
          </NavLink>
        </li>
      </ul>
      <div className="footer bg-cyan-100 rounded-2xl">
        ...
        <div className="text-xl font-bold mb-2">V2.0 is available</div>
        <button className="border-1 border-cyan-300 bg-white rounded-lg text-black hover:bg-cyan-500 transition duration-400 px-14 py-1 mb-4">
          Try now
        </button>
      </div>
    </div>
